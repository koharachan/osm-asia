...
const chinaRegionNames = {
  ...
  en: {
    ...
    wenshan: 'Wenshan Zhuang and Miao Autonomous Prefecture',
    qujing: 'Qujing',
    puer: "Pu'er",
    'dali-bai-autonomous': 'Dali Bai Autonomous Prefecture',
    lincang: 'Lincang',
    lijiang: 'Lijiang',
    kunming: 'Kunming',
    honghe: 'Honghe Hani and Yi Autonomous Prefecture',
    dehong: 'Dehong Dai and Jingpo Autonomous Prefecture',
    'baoshan-yunnan': 'Baoshan',
    chuxiong: 'Chuxiong Yi Autonomous Prefecture',
    tacheng: 'Tacheng',
    ili: 'Ili Kazakh Autonomous Prefecture',
    hotan: 'Hotan',
    altay: 'Altay',
    aksu: 'Aksu',
    nyingchi: 'Nyingchi',
...
const tibetPrefectureIds = [
  'nyingchi',
  'ngari'
]

const tianjinDistrictIds = [
  'xiqing',
  'wuqing',
  'ninghe',
  'nankai',
...
const anhuiCitySubtitles = {
  'zh-CN': '安徽市级 PBF',
  'zh-TW': '安徽市級 PBF',
  ja: '安徽省の市級 PBF',
  ko: '안후이 시급 PBF',
  en: 'Anhui city-level PBF',
  de: 'PBF auf Stadtebene in Anhui',
  my: 'Anhui city-level PBF',
  eo: 'Urbonivela PBF por Anhujo'
}

const zhejiangCitySubtitles = {
  'zh-CN': '浙江市级 PBF',
  'zh-TW': '浙江市級 PBF',
  ja: '浙江省の市級 PBF',
  ko: '저장 시급 PBF',
  en: 'Zhejiang city-level PBF',
  de: 'PBF auf Stadtebene in Zhejiang',
  my: 'Zhejiang city-level PBF',
  eo: 'Urbonivela PBF por Ĝeĝjango'
}

const yunnanPrefectureSubtitles = {
  'zh-CN': '云南市州级 PBF',
  'zh-TW': '雲南市州級 PBF',
  ja: '雲南省の市州級 PBF',
  ko: '윈난 시주급 PBF',
  en: 'Yunnan city/prefecture PBF',
  de: 'PBF auf Stadt- und Präfekturebene in Yunnan',
  my: 'Yunnan city/prefecture PBF',
  eo: 'Urbo- kaj prefekturnivela PBF por Junano'
}

const xinjiangPrefectureSubtitles = {
  'zh-CN': '新疆地区州级 PBF',
  'zh-TW': '新疆地區州級 PBF',
  ja: '新疆の地区州級 PBF',
  ko: '신장 지구주급 PBF',
  en: 'Xinjiang prefecture-level PBF',
  de: 'PBF auf Präfekturebene in Xinjiang',
  my: 'Xinjiang prefecture-level PBF',
  eo: 'Prefekturnivela PBF por Ŝinĝjango'
}

const tibetPrefectureSubtitles = {
  'zh-CN': '西藏地市级 PBF',
  'zh-TW': '西藏地市級 PBF',
  ja: 'チベットの地区市級 PBF',
  ko: '티베트 지구시급 PBF',
  en: 'Tibet prefecture/city PBF',
  de: 'PBF auf Präfektur- und Stadtebene in Tibet',
  my: 'Tibet prefecture/city PBF',
  eo: 'Prefektur- kaj urbonivela PBF por Tibeto'
}

const tianjinDistrictSubtitles = {
  'zh-CN': '天津区级 PBF',
  'zh-TW': '天津區級 PBF',
  ja: '天津市の区級 PBF',
  ko: '톈진 구급 PBF',
  en: 'Tianjin district-level PBF',
  de: 'PBF auf Bezirksebene in Tianjin',
  my: 'Tianjin district-level PBF',
  eo: 'Distriktnivela PBF por Tjanĝino'
}

const ningxiaCitySubtitles = {
  'zh-CN': '宁夏市级 PBF',
  'zh-TW': '寧夏市級 PBF',
  ja: '寧夏の市級 PBF',
  ko: '닝샤 시급 PBF',
  en: 'Ningxia city-level PBF',
  de: 'PBF auf Stadtebene in Ningxia',
  my: 'Ningxia city-level PBF',
  eo: 'Urbonivela PBF por Ningŝja'
}

const macauAreaSubtitles = {
  'zh-CN': '澳门分区 PBF',
  'zh-TW': '澳門分區 PBF',
  ja: 'マカオの地域別 PBF',
  ko: '마카오 지역 PBF',
  en: 'Macau area PBF',
  de: 'PBF für Macau-Gebiete',
  my: 'Macau area PBF',
  eo: 'Area PBF por Makao'
}

const liaoningCitySubtitles = {
  'zh-CN': '辽宁市级 PBF',
  'zh-TW': '遼寧市級 PBF',
  ja: '遼寧省の市級 PBF',
  ko: '랴오닝 시급 PBF',
  en: 'Liaoning city-level PBF',
  de: 'PBF auf Stadtebene in Liaoning',
  my: 'Liaoning city-level PBF',
  eo: 'Urbonivela PBF por Liaŭningo'
}
...
const regionSubtitleGroups = [
  ...
  { ids: anhuiCityIds, subtitles: anhuiCitySubtitles },
  { ids: zhejiangCityIds, subtitles: zhejiangCitySubtitles },
  { ids: yunnanPrefectureIds, subtitles: yunnanPrefectureSubtitles },
  { ids: xinjiangPrefectureIds, subtitles: xinjiangPrefectureSubtitles },
  { ids: tibetPrefectureIds, subtitles: tibetPrefectureSubtitles },
  { ids: tianjinDistrictIds, subtitles: tianjinDistrictSubtitles },
  { ids: ningxiaCityIds, subtitles: ningxiaCitySubtitles },
  { ids: macauAreaIds, subtitles: macauAreaSubtitles },
  { ids: liaoningCityIds, subtitles: liaoningCitySubtitles }
]
